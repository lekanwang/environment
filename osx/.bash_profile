...
#   Gradle-related shortcuts
alias ass='./gradlew assemble'
alias build='./gradlew build'
alias clean='./gradlew clean'
alias eclipse='./gradlew eclipse'
alias publish='./gradlew publish'
alias run='./gradlew run'
alias pas='./gradlew pas'
alias bnp='./gradlew build && ./gradlew publish'
alias bnr='./gradlew build && ./gradlew run'
deps() { ./gradlew -PnoFail "$1":dependencies | less ; }
